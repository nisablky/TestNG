...
public class C03_Priority extends TestBase {
    ...
    eger isim siralamasinin bir siralama ile calismasini isterseniz
    o zaman test method'larina oncelik (priority) tanimlayabiliriz

    priority kuucukten buyuge gore calisir
    eger bir test method'una proirity degeri atanmamissa
